...
# logical coordinates, not pixel dimensions
# Creates a coordinate space that's 640 units wide and 480 units tall
ortho_width = 640
ortho_height = 480
...
while not done:
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            # If you click at x=500 on screen, it maps to x=320 in OpenGL
